...
```{r echo=FALSE, out.width='75%', fig.align='center', fig.cap='Photo by ZSun Fu on Unsplash.'}
knitr::include_graphics("images/05/coin-in-hand.jpg")
```
...
```{r echo=FALSE, fig.align='center', fig.cap='A common task used to test for the shape bias.'}
knitr::include_graphics("images/05/shape_bias.gif")
```
