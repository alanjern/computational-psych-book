...
Let's define a function that calculates the choice probability in @eq-choicemodel. This is our likelihood function. Run the code below to define the function.
...
Let's write a function to do this. Run the code below to define the function.
